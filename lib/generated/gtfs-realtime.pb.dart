...
class Alert extends $pb.GeneratedMessage {
  factory Alert({
    ...
    $core.Iterable<TimeRange>? communicationPeriod,
    $core.Iterable<TimeRange>? impactPeriod,
    ...
    if (communicationPeriod != null)
      result.communicationPeriod.addAll(communicationPeriod);
    if (impactPeriod != null) result.impactPeriod.addAll(impactPeriod);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pPM<TimeRange>(2, _omitFieldNames ? '' : 'communicationPeriod',
        subBuilder: TimeRange.create)
    ..pPM<TimeRange>(3, _omitFieldNames ? '' : 'impactPeriod',
        subBuilder: TimeRange.create)
  ...
  /// If multiple ranges are given, the alert will be shown during all of them.
  @$pb.TagNumber(2)
  $pb.PbList<TimeRange> get communicationPeriod => $_getList(1);
  ...
  @$pb.TagNumber(3)
  $pb.PbList<TimeRange> get impactPeriod => $_getList(2);

  /// Entities whose users we should notify of this alert.
  @$pb.TagNumber(5)
  $pb.PbList<EntitySelector> get informedEntity => $_getList(3);

  @$pb.TagNumber(6)
  Alert_Cause get cause => $_getN(4);
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  Alert_Effect get effect => $_getN(5);
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(10)
  TranslatedString get headerText => $_getN(7);
  @$pb.TagNumber(10)
  set headerText(TranslatedString value) => $_setField(10, value);
  @$pb.TagNumber(10)
  $core.bool hasHeaderText() => $_has(7);
  @$pb.TagNumber(10)
  void clearHeaderText() => $_clearField(10);
  @$pb.TagNumber(10)
  TranslatedString ensureHeaderText() => $_ensure(7);

  /// Full description for the alert as plain-text. The information in the
  /// description should add to the information of the header.
  @$pb.TagNumber(11)
  TranslatedString get descriptionText => $_getN(8);
  @$pb.TagNumber(11)
  set descriptionText(TranslatedString value) => $_setField(11, value);
  @$pb.TagNumber(11)
  $core.bool hasDescriptionText() => $_has(8);
  @$pb.TagNumber(11)
  void clearDescriptionText() => $_clearField(11);
  @$pb.TagNumber(11)
  TranslatedString ensureDescriptionText() => $_ensure(8);

  /// Text for alert header to be used in text-to-speech implementations. This field is the text-to-speech version of header_text.
  @$pb.TagNumber(12)
  TranslatedString get ttsHeaderText => $_getN(9);
  @$pb.TagNumber(12)
  set ttsHeaderText(TranslatedString value) => $_setField(12, value);
  @$pb.TagNumber(12)
  $core.bool hasTtsHeaderText() => $_has(9);
  @$pb.TagNumber(12)
  void clearTtsHeaderText() => $_clearField(12);
  @$pb.TagNumber(12)
  TranslatedString ensureTtsHeaderText() => $_ensure(9);

  /// Text for full description for the alert to be used in text-to-speech implementations. This field is the text-to-speech version of description_text.
  @$pb.TagNumber(13)
  TranslatedString get ttsDescriptionText => $_getN(10);
  @$pb.TagNumber(13)
  set ttsDescriptionText(TranslatedString value) => $_setField(13, value);
  @$pb.TagNumber(13)
  $core.bool hasTtsDescriptionText() => $_has(10);
  @$pb.TagNumber(13)
  void clearTtsDescriptionText() => $_clearField(13);
  @$pb.TagNumber(13)
  TranslatedString ensureTtsDescriptionText() => $_ensure(10);

  @$pb.TagNumber(14)
  Alert_SeverityLevel get severityLevel => $_getN(11);
  @$pb.TagNumber(14)
  set severityLevel(Alert_SeverityLevel value) => $_setField(14, value);
  @$pb.TagNumber(14)
  $core.bool hasSeverityLevel() => $_has(11);
  @$pb.TagNumber(14)
  ...
  @$pb.TagNumber(15)
  TranslatedImage get image => $_getN(12);
  @$pb.TagNumber(15)
  ...
  @$pb.TagNumber(15)
  TranslatedImage ensureImage() => $_ensure(12);

  /// Text describing the appearance of the linked image in the `image` field (e.g., in case the image can't be displayed
  /// or the user can't see the image for accessibility reasons). See the HTML spec for alt image text - https://html.spec.whatwg.org/#alt.
  @$pb.TagNumber(16)
  TranslatedString get imageAlternativeText => $_getN(13);
  @$pb.TagNumber(16)
  set imageAlternativeText(TranslatedString value) => $_setField(16, value);
  @$pb.TagNumber(16)
  $core.bool hasImageAlternativeText() => $_has(13);
  @$pb.TagNumber(16)
  void clearImageAlternativeText() => $_clearField(16);
  @$pb.TagNumber(16)
  TranslatedString ensureImageAlternativeText() => $_ensure(13);
  ...
  /// NOTE: This field is still experimental, and subject to change. It may be formally adopted in the future.
  @$pb.TagNumber(17)
  TranslatedString get causeDetail => $_getN(14);
  @$pb.TagNumber(17)
  set causeDetail(TranslatedString value) => $_setField(17, value);
  @$pb.TagNumber(17)
  $core.bool hasCauseDetail() => $_has(14);
  @$pb.TagNumber(17)
  void clearCauseDetail() => $_clearField(17);
  @$pb.TagNumber(17)
  TranslatedString ensureCauseDetail() => $_ensure(14);
  ...
  /// NOTE: This field is still experimental, and subject to change. It may be formally adopted in the future.
  @$pb.TagNumber(18)
  TranslatedString get effectDetail => $_getN(15);
  @$pb.TagNumber(18)
  set effectDetail(TranslatedString value) => $_setField(18, value);
  @$pb.TagNumber(18)
  $core.bool hasEffectDetail() => $_has(15);
  @$pb.TagNumber(18)
  void clearEffectDetail() => $_clearField(18);
  @$pb.TagNumber(18)
  TranslatedString ensureEffectDetail() => $_ensure(15);
}
